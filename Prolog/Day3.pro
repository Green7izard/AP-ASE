...
%SWI prolog has no fd_all_diffrent or fd_domain
% http://www.swi-prolog.org/pldoc/doc_for?object=all_different(/1
%From the book
valid([]).
...
sudoku(Puzzle, Solution) :-
	...
	% http://stackoverflow.com/questions/16577350/prolog-fd-domain-is-being-undefined
	Puzzle ins 1..9,
	...
	!,	print_row([Row1, Row2, Row3, Row4, Row5, Row6, Row7, Row8, Row9]).

print_row([]) :- writeln("").
print_row([Head | Tail]) :- writeln(Head), print_row(Tail).
